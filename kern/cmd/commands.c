...
struct Command commands[] =
{
		...
		{ "schedPRIRR", "Initialize Priority RR Scheduler" ,command_RR_init, 3},
		//**************************************//
...
int command_RR_init(int number_of_arguments, char **arguments)
{
	uint32 numOfPriority = strtol(arguments[1], NULL, 10);
	uint32 quantum = strtol(arguments[2], NULL, 10);
